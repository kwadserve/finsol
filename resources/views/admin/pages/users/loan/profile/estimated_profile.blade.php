...
<div class="networthrd mb-3">
    ...
    <div class="networthrd-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$estimatedDetails->email_id}}
        </div>
...
<div class="networthrd mb-3">
    ...
    <div class="networthrd-body bg-light">
        ...
        ['documents'=> $estimatedDocuments,'form_type'=>'LFEstimated', 'details'=>$estimatedDetails])
    </div>
