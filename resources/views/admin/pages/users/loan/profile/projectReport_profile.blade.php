...
<div class="projectReportrd mb-3">
    ...
    <div class="projectReportrd-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$projectReportDetails->email_id}}
        </div>
...
<div class="projectReportrd mb-3">
    ...
    <div class="projectReportrd-body bg-light">
        ...
        ['documents'=> $projectReportDocuments,'form_type'=>'LFProjectReport', 'details'=>$projectReportDetails])
    </div>
