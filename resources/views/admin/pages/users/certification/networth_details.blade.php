...
<script>
    ...
    function openNetworthNoteModal(itemId) {
        ...
        $.ajax({
            ...
            url: urlpath + '/user/certification/statusview' + '?for=note&formtype=networth&id=' + itemId,
            type: 'GET',
    ...
    function openNetworthApproveModal(itemId) {
        ...
        $.ajax({
            // url:  urlpath+'/user/forms/statusview' +'?pan=' + itemId,
            url: urlpath + '/user/certification/statusview' + '?for=approve&formtype=networth&id=' + itemId,
            type: 'GET',
            success: function(data) {
