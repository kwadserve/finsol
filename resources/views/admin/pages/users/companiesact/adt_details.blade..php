@if($usersAdt) 
<div class="row">  <h5>ADT Form Details</h5>
                            <div class="col-12">
                                <div id="tableExample"
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-0">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td><a href="{{ url('admin/user/companiesact/details/adt'.$detail->id) }}">Details</a></td>
                                                    <td>
                                                        @if($detail->status == 2)
                                                        <div><span
                                                    ...
                                                    <td colspan=6 style="display:flex;">
                                                        <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                           ...
                                                           href="{{ url('companiesact/statusview/'.$detail->id) }}" data-target="#myAdtNoteModal">
                                                            Note<span class="glyphicon glyphicon-eye-open ms-1"></span>
                                                        </span> 

 
                                                         <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                            type="button" data-toggle="modal"  onclick="openAdtApproveModal({{ $detail->id }})"
