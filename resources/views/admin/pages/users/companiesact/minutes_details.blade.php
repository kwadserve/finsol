@if($usersMinutes) 
<div class="row">  <h5>Minutes Form Details</h5>
                            <div class="col-12">
                                <div id="tableExample"
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-0">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td><a href="{{ url('admin/user/companiesact/details/minutes'.$detail->id) }}">Details</a></td>
                                                    <td>
                                                        @if($detail->status == 2)
                                                        <div><span
                                                    ...
                                                    <td colspan=6 style="display:flex;">
                                                        <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                           ...
                                                           href="{{ url('companiesact/statusview/'.$detail->id) }}" data-target="#myMinutesNoteModal">
                                                            Note<span class="glyphicon glyphicon-eye-open ms-1"></span>
                                                        </span> 

 
                                                         <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                            type="button" data-toggle="modal"  onclick="openMinutesApproveModal({{ $detail->id }})"
                                                         ...
                                                         var urlpath="{{ $routeurl }}";
                                                            function openMinutesNoteModal(itemId) {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: urlpath+'/user/companiesact/statusview' +'?for=note&formtype=minutes&id=' + itemId,
                                                                    type: 'GET',
                                                            ...
                                                            function openMinutesApproveModal(itemId) {
                                                                ...
                                                                $.ajax({
                                                                    // url:  urlpath+'/user/forms/statusview' +'?pan=' + itemId,
                                                                    url: urlpath+'/user/companiesact/statusview' +'?for=approve&formtype=minutes&id=' + itemId,
                                                                    type: 'GET',
                                                                    success: function (data) {
