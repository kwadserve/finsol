@if ($usersStatutoryaudit)
    <div class="row">
        <h5>Statutory Audit Form Details</h5>
        <div class="col-12">
            <div id="tableExample"
                            ...
                            @if ($usersStatutoryaudit)
                                @foreach ($usersStatutoryaudit as $detail)
                                    <tr class="align-middle">
                                        ...
                                        <td><a
                                                href="{{ url('admin/user/companiesact/details/statutoryaudit/' . $detail->id) }}">Details</a>
                                        </td>
                                        <td>
                                            @if ($detail->status == 2)
                                                <div><span
                                        ...
                                        @if ($detail->status == 1 || $detail->status == 3)
                                            <td colspan=6 style="display:flex;">
                                                ...
                                                <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                    ...
                                                    onclick="openStatutoryauditApproveModal({{ $detail->id }})"
