@if ($usersAoc)
    <div class="row">
        <h5>AOC Form Details</h5>
        <div class="col-12">
            <div id="tableExample"
                data-list='{"valueNames":["name","email_id","age"],"page":5,"pagination":true}'>
                            ...
                            @if ($usersAoc)
                                @foreach ($usersAoc as $detail)
                                    <tr class="align-middle">
                                        ...
                                        <td><a
                                                href="{{ url('admin/user/companiesact/details/aoc/' . $detail->id) }}">Details</a>
                                        </td>
                                        <td>
                                            @if ($detail->status == 2)
                                                <div><span
                                        ...
                                        @if ($detail->status == 1 || $detail->status == 3)
                                            <td colspan=6 style="display:flex;">
                                                ...
                                                <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                    ...
                                                    onclick="openAocApproveModal({{ $detail->id }})"
