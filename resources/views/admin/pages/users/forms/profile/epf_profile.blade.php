...
<div class="card mb-3">
    ...
    <div class="card-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="mobile">Mobile : </label>{{$epfDetails->epf_mobile}}
        </div>
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$epfDetails->epf_email}}
        </div>
