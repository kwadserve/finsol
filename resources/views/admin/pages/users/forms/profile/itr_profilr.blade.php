...
@if($itrDetails)
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-light row">
                    <div class="col-lg-6 mb-3"> <label class="form-label" for="gst-type">Name of Itr : </label>{{$itrDetails->name_of_itr}}</div>
                    <div class="col-lg-6 mb-3"> <label class="form-label" for="pan-number">ITR Number : </label>{{$itrDetails->itr_number}}</div>
                    <div class="col-lg-6 mb-3"> <label class="form-label" for="mobile">Mobile : </label>{{$itrDetails->mobile_number}}</div>
                    <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$itrDetails->email_id}}</div>
