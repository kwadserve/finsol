@if($usersItr) 
<div class="row">  <h5>ITR Form Details</h5>
                            <div class="col-12">
                                <div id="tableExample"
                                    ...
                                    @if (session('additionalfilenotexist_itr'))
                                                        <div class="alert alert-danger border-2 d-flex align-items-center"
                                                            ...
                                                            <p class="mb-0 flex-1">{{ session('additionalfilenotexist_itr') }}</p>
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-0">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr class="align-middle" data-toggle="collapse"  class="accordion-toggle">
                                                    ...
                                                    <td><a href="{{ url('admin/user/forms/details/itr/'.$detail->id) }}">Details</a></td>
                                                    <td>
                                                        @if($detail->status == 2)
                                                        <div><span
                                                    ...
                                                    <td colspan=6 style="display:flex;">
                                                        <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                            type="button"  onclick="openItrNoteModal({{ $detail->id }})"
                                                           href="{{ url('forms/statusview/'.$detail->id) }}" data-target="#myItrNoteModal">
                                                            Note<span class="glyphicon glyphicon-eye-open ms-1"></span>
                                                        </span> 

 
                                                         <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                            type="button" data-toggle="modal"  onclick="openItrApproveModal({{ $detail->id }})"
                                                             
                                                            data-target="#myItrApprovedModal"> 
                                                            Approve<span
