                            ...
                            @if ($usersFactoryLicense)
                                @foreach ($usersFactoryLicense as $detail)
                                    <tr class="align-middle" data-toggle="collapse" class="accordion-toggle">
                                        ...
                                        <td class="text-nowrap">{{ $detail->name_of_firm ? $detail->name_of_firm : '--' }}
                                        </td>
                                        ...
                                        <td><a
                                                href="{{ url('admin/user/forms/details/factorylicense/' . $detail->id) }}">Details</a>
                                        </td>
                                        ...
                                        @if ($detail->status == 1 || $detail->status == 3)
                                            <td colspan=6 style="display:flex;">
                                                <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                    type="button"
                                                    onclick="openFactoryLicenseNoteModal({{ $detail->id }})"
                                                    href="{{ url('forms/statusview/' . $detail->id) }}"
                                                    data-target="#myFactoryLicenseNoteModal">
                                                ...
                                                <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                    ...
                                                    onclick="openFactoryLicenseApproveModal({{ $detail->id }})"
