                                ...
                                @foreach ($usersPartnership as $detail)
                                    <tr class="align-middle" data-toggle="collapse" class="accordion-toggle">
                                        ...
                                        <td class="text-nowrap">
                                            {{ $detail->name_of_partnership ? $detail->name_of_partnership : '--' }}</td>
                                        ...
                                        <td><a
                                                href="{{ url('admin/user/forms/details/partnership/' . $detail->id) }}">Details</a>
                                        </td>
                                        <td>
                                        ...
                                        @if ($detail->status == 1 || $detail->status == 3)
                                            <td colspan=6 style="display:flex;">
                                                <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                    type="button"
                                                    onclick="openPartnershipNoteModal({{ $detail->id }})"
                                                    href="{{ url('forms/statusview/' . $detail->id) }}"
                                                    data-target="#myPartnershipNoteModal">
                                                ...
                                                <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                    ...
                                                    onclick="openPartnershipApproveModal({{ $detail->id }})"
