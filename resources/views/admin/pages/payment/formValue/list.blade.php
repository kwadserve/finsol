                ...
                <div class="card h-md-100 ecommerce-card-min-width">
                    ...
                    <div class="card-body d-flex flex-column justify-content-end">
                        @if ($values)
                            <div class="row">
                                <div class="col-12">
                                    <div id="tableExample" data-list='{"valueNames":["form_type","updated_at","value"],"page":5,"pagination":true}'>
                                                    ...
                                                    @if ($values)
                                                        @foreach ($values as $detail)
                                                            <tr class="align-middle">
                                                                <td class="text-nowrap">{{ $detail->form ? $detail->form : '--' }}</td>

                                                                <td class="text-nowrap">
                                                                    <input type="number" name="form_{{$detail->id}}" value="{{$detail->value}}">
                                                                </td>
                                                                <td>
                                                                    <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Value" type="button" onclick="updateValue('form_{{$detail->id}}', {{$detail->id}})">
                                                                        Update
