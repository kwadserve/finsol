<!-- <div class="mt-3">
                                                        <div class="alert alert-success border-2 d-flex align-items-center"
                                                            ...
                                                            <p class="mb-0 flex-1">A simple success alertâ€”check it
                                                                out!</p>
                                                            <button class="btn-close" type="button"
                                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                                        </div>
                                                        <div class="alert alert-info border-2 d-flex align-items-center"
                                                            role="alert">
                                                            <div class="bg-info me-3 icon-item"><span
                                                                    class="fas fa-info-circle text-white fs-3"></span>
                                                            </div>
                                                            <p class="mb-0 flex-1">A simple info alertâ€”check it
                                                                out!</p>
                                                            <button class="btn-close" type="button"
                                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                                        </div>
                                                        <div class="alert alert-warning border-2 d-flex align-items-center"
                                                            ...
                                                            <p class="mb-0 flex-1">A simple warning alertâ€”check it
                                                                out!</p>
                                                            <button class="btn-close" type="button"
                                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                                        </div>
                                                        <div class="alert alert-danger border-2 d-flex align-items-center"
                                                            ...
                                                            <p class="mb-0 flex-1">A simple danger alertâ€”check it
                                                                out!</p>
                                                            <button class="btn-close" type="button"
                                                                data-bs-dismiss="alert" aria-label="Close"></button>
                                                        </div>
