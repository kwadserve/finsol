    ...
    <div class="container" data-layout="container">
        ...
        <div class="content">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="col">
                    <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">New CA
                ...
                <div class="col-xl-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="needs-validation" novalidate="novalidate" action="{{route('ca.register')}}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="row g-2 ">
                                        @foreach ($caimages as $keyname => $image)
