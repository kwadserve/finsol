@if(count($userTurnoverDetails)>0)<b>Turnover Details</b>
<hr />
<table class="table table-condensed table-striped">
    ...
    <tbody>
        @if($userTurnoverDetails)
        @foreach($userTurnoverDetails as $key =>  $detail)
        ...
        class="accordion-toggle">
            ...
            <td colspan=7>
                ...
                <form action="{{ route('certification_web_approvedFile') }}" method="POST">
                    @csrf
                    <input type="hidden" name="form_type" value="Turnover">
        ...
        <tr>
            <td colspan="6" class="hiddenRow1">
                <div id="{{$detail->type.$key}}" class="accordian-body collapse ">
                    ...
                    <br /><br />
                    <div class="col">
                        <form class="needs-validation" novalidate="novalidate" action="{{route('certification_query_raised')}}"
                            ...
                            <div class="mt-3">
                                <label>Upload Required
                                    doc:</label>
                                <input type="file" name="additional_img[]" id="image-upload" class="myfrm form-control"
                                    multiple />
                            </div>
