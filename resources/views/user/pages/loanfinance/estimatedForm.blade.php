                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate="novalidate"
                                    action="{{ route('estimated.register') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mt-1 row g-2">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="form-wizard-progress-wizard-addregnum">Mobile
                                                    ...
                                                    required="" type="text" name="mobile_number" maxlength="10"
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="form-wizard-progress-wizard-addregnum">Proposed Loan Amount (TL/CC)</label>
                                                <input class="form-control"
                                                    required="" type="text" name="proposed_amount"
                                                    placeholder="Enter Proposed loan"
                                                    id="form-wizard-progress-wizard-addregnum" />
                                                <div class="invalid-feedback">You must add an amount</div>
                                            </div>
                                        </div>
                                        <!-- <div class="detailsmargin card-header d-flex flex-between-center bg-light py-2">
                                        ...
                                        <div class="row g-2 ">
                                            @foreach ($estimatedImages as $keyname => $image)
