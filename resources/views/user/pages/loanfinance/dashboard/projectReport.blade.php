@if (count($projectReport) > 0)<b>Project Report Details</b>
    <hr />
    <table class="table table-condensed table-striped">
        ...
        <tbody>
            @if ($projectReport)
                @foreach ($projectReport as $key => $detail)
                            ...
                            @if ($detail->payment_status == 'Credit')
                                ...
                                @else
                                    <form action="{{ route('dashboard.register') }}" method="POST">
                                        ...
                                        <input type="hidden" name="payment_amount" value="{{ $project_instamojo_amount }}">
                                        <input type="hidden" name="route" value="form_dashboard">
                                        <input type="hidden" name="payment_purpose" value="LFProjectReport">
