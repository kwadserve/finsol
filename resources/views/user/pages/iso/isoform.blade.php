                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate="novalidate" action="{{route('iso.register')}}"
                                ...
                                <div class="mt-1 row g-2">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                         <label class="form-label" for="bootstrap-wizard-validation-wizard-company">Name for ISO
                                         </label><input class="form-control" type="text" name="iso_name" placeholder="Name for ISO"
                                             required="required" />
