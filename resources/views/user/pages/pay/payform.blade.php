    ...
    <div class="container" data-layout="container">
        ...
        <div class="content">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="col">
                    <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Custom Payment
                ...
                <div class="col-xl-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="needs-validation" novalidate="novalidate" action="{{route('pay.register')}}"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="bootstrap-wizard-validation-wizard-email">Payment For
                                            </label><input class="form-control" type="text" name="payment_for"
                                                placeholder="Payment For"
                                                
                                                required="required" id="bootstrap-wizard-validation-wizard-email"
                                                  />
                                            <div class="invalid-feedback">You must add Payment For</div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label class="form-label"
                                                ...
                                                required="required" id="bootstrap-wizard-validation-wizard-email"
                                                  />
                                            <div class="invalid-feedback">You must add Amount</div>
                                        </div>
                                    </div>
