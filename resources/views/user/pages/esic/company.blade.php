         ...
         <div class="mt-1 row g-2">
             <div class="col-6">
                 <div class="mb-3">
                     ...
                     </label><input class="form-control" type="text" name="name_of_esic"
             ...
             <div class="col-6">
                 <div class="mb-3">
                     <label class="form-label" for="form-wizard-progress-wizard-addregnum">
                         ...
                         name="esicsignatory[0][mobile]" maxlength="10" placeholder="Enter Mobile No"
                         id="form-wizard-progress-wizard-addregnum" />
                     <div class="invalid-feedback">Please provide Mobile
                         number</div>
                 </div>
 ...
 <script>
     ...
     $('.addesicsignatory').click(function() {
         ...
         $(this).before(
             ...
             esicsignatoryIndex +
             '][mobile]" placeholder="Enter Registration No" id="form-wizard-progress-wizard-addregnum"> <div class="invalid-feedback">Please provide Mobile number</div> </div> </div> <div class="col-4 mb-3"> <div class="mb-3"> <label>Upload Aadhar :</label> <!-- required="required" --> <input type="file" name="esicsignatory[' +
             esicsignatoryIndex +
