 <form class="needs-validation" novalidate="novalidate" action="{{route('huf.register')}}" method="post"
     ...
     <div class="detailsmargin card-header d-flex flex-between-center bg-light py-2">
         <h6 class="detailspadding mb-0">Details of your Trust/NGO</h6>
     </div>
     ...
     <div class="col-6">
        <div class="mb-3">
         ...
         </label><input class="form-control" type="text" name="email_id" placeholder="Name of Trust/NGO"
             required="required" />
             <div class="invalid-feedback">Please provide name of Trust/NGO</div>
        </div>
     </div>
     <div class="col-6">
             <div class="mb-3">
      ...
      <div class="col-6">
        <div class="mb-3">
         ...
         </label><input class="form-control" type="text" name="email_id" placeholder="Nature of Trust/NGO"
             required="required" />
              <div class="invalid-feedback">Please provide nature of Trust/NGO</div>
        </div>
     </div>
      <div class="col-6">
             <div class="mb-3">
          ...
          <div class="col-6 mb-3">
             <div class="mb-3">
                 <label>Address proof of Business</label>
                 <!-- required="required"  -->
     ...
     <div class="mt-1 row g-2" id="companysignatoryGroup">
        ...
        <div class="mb-3">
         <label class="form-label" for="bootstrap-wizard-validation-wizard-company">Name of Trustee/Member
             ...
             required="required" />
              <div class="invalid-feedback">Please provide name of Trustee/Member</div>
        </div>
     </div>
         ...
         <div class="col-6 mb-3">
             <div class="mb-3">
                 <label>Photo of Trustee/Member</label>
                 <!-- required="required"  -->
                 <input type="file" name="#" id="image-upload"
                     class="myfrm form-control" multiple />
             </div>
     ...
     <div class="mt-1 row g-2">
         <button class="addcompanysignatory btn btn-primary me-1 mb-1" type="button">
             <span class="fas fa-plus me-1" data-fa-transform="shrink-3"></span>Add Trustee/Member
         </button>
     </div>
     ...
     <div class="col-4">
         <div class="mb-3">
             ...
             <p>Amount : ₹5000 (Fee - ₹5000 + Stamp Duty will be charged seperatly as per government norms)</p>
         </div>
     </div>
 </form>
...
$('.addcompanysignatory').click(function() {
    ...
    $(this).before(
        ...
        companysignatoryIndex +
        '][comp_sign_declare_img][]" id="image-upload" class="myfrm form-control" multiple=""> </div> </div> <div class="mt-1 row g-2"> <button class="deletecompanysignatory btn btn-outline-primary me-1 mb-1" type="button"><span class="fas fa-trash me-1" data-fa-transform="shrink-3"></span> Delete Trustee/Member</button> </div></div>'
