<form class="needs-validation" novalidate="novalidate" action="{{route('trust.register')}}" method="post"
     ...
     <div class="col-6">
      ...
      <div class="col-6">
        <div class="mb-3">
         ...
         </label><input class="form-control" type="text" name="nature_of_trust" placeholder="Nature of Trust/NGO"
             required="required" />
     ...
     <div class="mt-1 row g-2" id="trustmemberGroup">  
        <div class="col-6">
            ...
            </label><input class="form-control" type="text" name="trustmember[0][name_of_member]" placeholder="Name of Karta"
                required="required" />
...
$('.addtrustmember').click(function() {
   ...
   var html = '<div class="mt-1 row g-2" id="trustmemberGroup" style=" white-space: nowrap;"> <div class="col-6"> <div class="mb-3"> <label class="form-label" for="bootstrap-wizard-validation-wizard-company">Name of Trustee/Member </label><input class="form-control" type="text" name="trustmember['+trustmemberIndex+'][name_of_member]" placeholder="Name of Member" required="required"> <div class="invalid-feedback">Please provide name of Member</div></div></div><div class="col-4 mb-3"> <div class="mb-3"> <label>Photo of Trustee/Member :</label> <input type="file" name="trustmember['+trustmemberIndex+'][trust_of_member_img][]" id="image-upload" class="myfrm form-control" multiple=""> </div></div>';
       html+= '<div class="mt-1 row g-2"><button class="deletetrustmember btn btn-outline-primary me-1 mb-1" type="button"><span class="fas fa-trash me-1" data-fa-transform="shrink-3"></span> Delete Member</button> </div></div>';
    $(this).before(html);
});
