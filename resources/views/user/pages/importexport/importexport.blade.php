 <form class="needs-validation" novalidate="novalidate" action="{{route('company.register')}}" method="post"
          ...
          <div class="mt-1 row g-2">
                                    <div class="col-6">
                                        <div class="mb-3">
                                         ...
                                         </label><input class="form-control" type="text" name="#" placeholder="Name of Business/Firm"
                                             required="required" />
     ...
     <div class="mt-1 row g-2">
         ...
         <div class="col-6">
             <div class="mb-3">
                 <label>PAN Card of Firm/Company</label>
                 <input type="file" name="#" id="image-upload" class="myfrm form-control"
                     multiple />
             </div>
         </div>
         <div class="col-6">
             <div class="mb-3">
                 <label>Cancelled Cheque of Bank Account/s</label>
                 <input type="file" name="#" id="image-upload" class="myfrm form-control"
                     multiple />
             </div>
         </div>
        ...
        <div class="col-6">
             <div class="mb-3">
                 <label>PAN Card of Authorised Signatory</label>
                 <input type="file" name="#" id="image-upload" class="myfrm form-control"
                     multiple />
             </div>
         </div>
        <div class="col-6">
             <div class="mb-3">
                 <label>Aadhar Card of Authorised Signatory</label>
                 <input type="file" name="#" id="image-upload" class="myfrm form-control"
                     multiple />
             </div>
         </div>
