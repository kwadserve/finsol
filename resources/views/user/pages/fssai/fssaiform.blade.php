    ...
    <div class="container" data-layout="container">
        ...
        <div class="content">
            ...
            <div class="d-flex mb-4">
                ...
                <div class="col">
                    <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">New Fssai
                            Registration</span><span
                            class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span>
                    </h5>
                    <p class="mb-0">Get your FSSAI number quickly with Finsol</p>
                </div>
            </div>
            <div class="row g-0">
                <div class="col-xl-12">
                    <div class="card mb-3">
                      <!--  <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="needs-validation" novalidate="novalidate" action="{{route('fssai.register')}}"
                                ...
                                <div class="mt-1 row g-2">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                         <label class="form-label" for="bootstrap-wizard-validation-wizard-company">Name for FSSAI
                                         </label><input class="form-control" type="text" name="fssai_name" placeholder="Name for FSSAI"
                                             required="required" />
                                             <div class="invalid-feedback">Please provide name FSSAI</div>
                                        </div>
                                     </div>
                                     <!-- to be connected to backend --->
                                    ...
                                    <div class="row g-2 ">
                                        @foreach ($fssaiimages as $keyname => $image)
