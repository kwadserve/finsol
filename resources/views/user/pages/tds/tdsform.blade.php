                                ...
                                <div class="mt-1 row g-2">
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                         ...
                                         </label><input class="form-control" type="text" name="tds_name" placeholder="Name for TDS"
                                             required="required" />
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            <label class="form-label" for="form-wizard-progress-wizard-addregnum">Mobile
                                                ...
                                                type="text" name="mobile_number" maxlength="10" placeholder="Enter Mobile No"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="form-wizard-progress-wizard-tds">Date of TDS/TCS </label><input class="form-control" required=""
                                                type="text" name="tds_date" placeholder=""
                                                id="form-wizard-progress-wizard-tds" />
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="form-wizard-progress-wizard-amount">Amount
                                                (Gross) </label><input class="form-control" required=""
                                                type="text" name="tds_amount" placeholder="Enter Pan No"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            Rate of TDS</label><input class="form-control" required=""
                                                type="text" name="tds_rate" placeholder="Enter Rate No"
                                                id="form-wizard-progress-wizard-rate" />
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            Section</label><input class="form-control" required=""
                                                type="text" name="section" placeholder=""
                                                id="form-wizard-progress-wizard-section" />
