                ...
                <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel"
                        ...
                        <ul class="nav nav-pills" id="pill-switch" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="epf-new-home" data-bs-toggle="tab"
                                    href="#epf-new" role="tab" aria-controls="epf-new"
                                    aria-selected="true">New</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" id="epf-existing-home" data-bs-toggle="tab"
                                    href="#epf-existing" role="tab" aria-controls="epf-existing"
