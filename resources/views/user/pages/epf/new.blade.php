<div class="tab-pane fade show active" id="epf-new" role="tabpanel" aria-labelledby="new-tab">
    <div class="d-flex mb-4">
        ...
        <div class="col">
            <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">New EPF
                    Registration</span><span
                    class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span>
            </h5>
            <p class="mb-0">Get your EPF registration done quicly with Finsol</p>
        </div>
    </div>
    <div class="row g-0">
        <div class="col-xl-12">
                        ...
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            ...
                            <ul class="nav nav-pills" id="pill-myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="epf-company-home"
                                        ...
                                        aria-controls="epf-company" aria-selected="true">Company</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" id="epf-company-other" data-bs-toggle="tab"
                                        href="#epf-others" role="tab" aria-controls="epf-others"
                                        aria-selected="false">Others</a></li>

                            </ul>
                            <div class="tab-content mt-3" id="pill-myTabContent">
                                <!------------------tab 1----------------->
                                @include('user.pages.epf.company')
                                <!------------Tab 2 ------------>
                                @include('user.pages.epf.others')
