                            ...
                            <div class="card-header position-relative min-vh-25 mb-8">
                                ...
                                <div class="avatar avatar-5xl avatar-profile shadow-sm img-thumbnail rounded-circle">
                                    <div class="h-100 w-100 rounded-circle overflow-hidden position-relative">
                                        ...
                                        <input class="d-none" id="profile-image"
                                        type="file" />
                            ...
                            <div class="card-body bg-light">
                                <form class="row g-3">
                                    ...
                                    <div class="col-lg-6"> <label class="form-label" for="last-name">Aadhaar Number</label><input
                                            class="form-control" id="last-name" type="text" value="{{$user->aadhaar}}" readonly="readonly"/></div>
                                    ...
                                    <div class="col-lg-12"><label class="form-label" for="email4">District</label><input
                                        class="form-control" id="email4" type="text" value="{{$district}}" readonly="readonly"/>
                                    </div>
                                    <div class="col-lg-12"><label class="form-label" for="email5">State</label><input
                                        class="form-control" id="email5" type="text" value="{{$state}}" readonly="readonly"/>
                                    </div>
