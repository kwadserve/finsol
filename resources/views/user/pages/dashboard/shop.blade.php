@if(count($userShopDetails)>0)<b>SHOP Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                @if($userShopDetails)
                                                                @foreach($userShopDetails as $key =>  $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type.$key}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_shop)?$detail->name_of_shop:'-'}}</td>
