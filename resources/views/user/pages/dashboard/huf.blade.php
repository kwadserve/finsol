@if(count($userHufDetails)>0)<b>HUF Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                @if($userHufDetails)
                                                                @foreach($userHufDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_huf)?$detail->name_of_huf:'-'}}</td>

                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">

                                                                            <div class="ms-2">{{$detail->huf_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <!-- <td class="text-nowrap">{{isset($detail->huf_mobile)?$detail->huf_mobile:'-'}}</td> -->
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$huf_instamojo_amount}}">
