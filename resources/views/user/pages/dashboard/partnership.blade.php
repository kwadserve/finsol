@if(count($userPartnershipDetails)>0)<b>PARTNERSHIP Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                @if($userPartnershipDetails)
                                                                @foreach($userPartnershipDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_partnership)?$detail->name_of_partnership:'-'}}</td>

                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">

                                                                            <div class="ms-2">{{$detail->partnership_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <!-- <td class="text-nowrap">{{isset($detail->partnership_mobile)?$detail->partnership_mobile:'-'}}</td> -->
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="name_of_pan" value="{{$detail->name_of_partnership}}">
                   <input type="hidden" name="mobile_number" value="{{$detail->partnership_mobile}}">
