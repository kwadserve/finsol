@if(count($userTrademarkDetails)>0)<b>TRADEMARK Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach($userTrademarkDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_trademark)?$detail->name_of_trademark:'-'}}</td>
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$trademark_instamojo_amount}}">
                   <input type="hidden" name="route" value="form_dashboard">
                   <input type="hidden" name="payment_purpose" value="Trademark">
                   <input type="hidden" name="email_id" value="{{$detail->trademark_email}}">
                   <input type="hidden" name="name_of_pan" value="{{$detail->name_of_trademark}}">
                   <input type="hidden" name="mobile_number" value="{{$detail->trademark_mobile}}">
