                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    ...
                                                                    <td colspan=7>
                                                                        @if($detail->status == 2)
                                                                           <span
                                                                            class="badge badge rounded-pill d-block p-2 badge-subtle-warning accordion-toggle"   data-bs-toggle="collapse" data-bs-target="#collapseContent1">Query
...
@endif
                                                                ...
                                                                <tr>
                                                                    <td colspan="6" class="hiddenRow1">
                                                                        <div id="collapseContent1"  class="accordian-body collapse ">
                                                                            <!-- {{$detail->gst_type}} -->
