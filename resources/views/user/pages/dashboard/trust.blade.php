@if(count($userTrustDetails)>0)<b>TRUST Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                @if($userTrustDetails)
                                                                @foreach($userTrustDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_trust)?$detail->name_of_trust:'-'}}</td>

                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">

                                                                            <div class="ms-2">{{$detail->trust_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <!-- <td class="text-nowrap">{{isset($detail->trust_mobile)?$detail->trust_mobile:'-'}}</td> -->
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$trust_instamojo_amount}}">
                   <input type="hidden" name="route" value="form_dashboard">
                   <input type="hidden" name="payment_purpose" value="Trust">
                   <input type="hidden" name="email_id" value="{{$detail->trust_email}}">
                   <input type="hidden" name="name_of_pan" value="{{$detail->name_of_trust}}">
                   <input type="hidden" name="mobile_number" value="{{$detail->trust_mobile}}">
