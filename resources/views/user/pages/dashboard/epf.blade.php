@if(count($userEpfDetails)>0)<b>EPF Details</b><hr/>
<table class="table table-condensed table-striped">
                                                                ...
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    ...
                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">
                                                                            ...
                                                                            <div class="ms-2">{{$detail->epf_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$epf_instamojo_amount}}">
                   ...
                   <input type="hidden" name="mobile_number" value="{{$detail->epf_mobile}}">
