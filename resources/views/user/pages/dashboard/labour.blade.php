@if(count($userLabourDetails)>0)<b>LABOUR Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                @if($userLabourDetails)
                                                                @foreach($userLabourDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    data-target="#{{$detail->type}}"
                                                                    class="accordion-toggle">

                                                                    <td class="text-nowrap">{{isset($detail->name_of_labour)?$detail->name_of_labour:'-'}}</td>

                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">

                                                                            <div class="ms-2">{{$detail->labour_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <!-- <td class="text-nowrap">{{isset($detail->Labour_mobile)?$detail->labour_mobile:'-'}}</td> -->
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$labour_instamojo_amount}}">
                   <input type="hidden" name="route" value="form_dashboard">
                   <input type="hidden" name="payment_purpose" value="Labour">
                   <input type="hidden" name="email_id" value="{{$detail->labour_email}}">
                   <input type="hidden" name="name_of_pan" value="{{$detail->name_of_labour}}">
                   <input type="hidden" name="mobile_number" value="{{$detail->labour_mobile}}">
