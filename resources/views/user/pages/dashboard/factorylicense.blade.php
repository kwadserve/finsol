@if(count($userFactoryLicenseDetails)>0)<b>FACTORY LICENSE Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach($userFactoryLicenseDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    ...
                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">
                                                                            ...
                                                                            <div class="ms-2">{{$detail->facl_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="form_type" value="Factory">
                   <input type="hidden" name="insert_id" value="{{$detail->id}}">
                   <input type="hidden" name="payment_amount" value="{{$factory_instamojo_amount}}">
                   ...
                   <input type="hidden" name="mobile_number" value="{{$detail->facl_mobile}}">
