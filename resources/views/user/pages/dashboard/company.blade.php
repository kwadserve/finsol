@if(count($userCompanyDetails)>0)<b>COMPANY Details</b><hr/>
<table class="table table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach($userCompanyDetails as $detail)
                                                                <tr class="align-middle" data-toggle="collapse"
                                                                    ...
                                                                    <td class="text-nowrap">
                                                                        <div class="align-items-center">
                                                                            ...
                                                                            <div class="ms-2">{{$detail->company_email}}
                                                                            </div>
                                                                        </div>
                                                                    </td>

                                                                    <!-- <td class="text-nowrap">{{isset($detail->company_mobile)?$detail->company_mobile:'-'}}</td> -->
               ...
               <form action="{{ route('dashboard.register') }}" method="POST">
                   ...
                   <input type="hidden" name="payment_amount" value="{{$company_instamojo_amount}}">
                   ...
                   <input type="hidden" name="mobile_number" value="{{$detail->company_mobile}}">
